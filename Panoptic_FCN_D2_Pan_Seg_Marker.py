...
MetadataCatalog.get("marker_val_separated").thing_colors = fixed_colors
MetadataCatalog.get("marker_val_separated").stuff_colors = fixed_stuff_colors

metadata = MetadataCatalog.get("marker_val_separated")
...
def run_pan_inference_on_random_images(num_images):
    ...
    metadata = MetadataCatalog.get("marker_val_separated")
    dataset_dicts = DatasetCatalog.get("marker_val_separated")
